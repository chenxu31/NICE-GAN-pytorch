...
def parse_args():
    ...
    parser.add_argument('--aug_points', type=float, default=0, help="augmentation parameter:points")
    parser.add_argument('--aug_rotate', type=float, default=0, help="augmentation parameter:rotate")
    parser.add_argument('--aug_zoom', type=float, default=0, help="augmentation parameter:zoom")
